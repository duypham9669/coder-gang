...
@section('content')
    ...
    <div class="h-section story">
        <div class="col-lg-12" id="h-introframe" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.1)),{{url('/images/portrait3.png')}};">
            <div class="h-text-intro" >
                <h2>WOMEN OF SAFE CITY</h2>
            </div>
            <nav class="header-nav">
                <a href="{{url('stories')}}" class="stories-header" id="id-stories-header">
                    Stories
                </a>
                ...
                <span class="nav-spacer"></span>
                <a href="#id_container_header" class="witness-header" id="id-witness-header">
                    Witness
                </a>
            </nav>
            <div class="h-nav-description">
                <p id="h-nav-description-up" style="margin: 0px 20px;">"Because you are women, people will force their thinking on you, their boundaries on you. They will tell you how to dress, how to behave, who you can meet and where you can go. Don't live in the shadows of people's judgement. Make your own choices in the light of your own wisdom."</p>
        ...
        <div class="col-lg-12 infs" id="infs">
            <div class="row">
                <div class="col-lg-4 card border-0 inf">
                    <img src="images/portrait3.jpg" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title"><u><b>#1WITNESS</b></u></h5>
                ...
                <div class="col-lg-4 card border-0  inf">
                    <img src="images/portrait4.jpg" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title"><u><b>#2WITNESS</b></u></h5>
                        <p class="card-text">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a vulputate arcu, lobortis elementum ipsum. Curabitur vestibulum turpis eu semper porttitor. Duis at turpis vitae augue condimentum hendrerit. Phasellus a arcu et magna pulvinar sagittis. Aenean volutpat nunc vel vulputate tincidunt. Ut interdum neque non ante mollis vulputate. Aliquam erat volutpat. Fusce vulputate, massa sit amet aliquam accumsan, neque nulla dictum odio, sed mollis diam felis sed orci. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vivamus vel risus ligula. Aliquam tempus maximus dui id malesuada. In pellentesque rutrum tellus, accumsan euismod augue pulvinar quis. Proin sed egestas lorem.</p>
                    </div>
                </div>
                <div class="col-lg-4 card border-0  inf">
                    <img src="images/portrait6.jpg" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title"><u><b>#3WITNESS</b></u></h5>
                        <p class="card-text">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a vulputate arcu, lobortis elementum ipsum. Curabitur vestibulum turpis eu semper porttitor. Duis at turpis vitae augue condimentum hendrerit. Phasellus a arcu et magna pulvinar sagittis. Aenean volutpat nunc vel vulputate tincidunt. Ut interdum neque non ante mollis vulputate. Aliquam erat volutpat. Fusce vulputate, massa sit amet aliquam accumsan, neque nulla dictum odio, sed mollis diam felis sed orci. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vivamus vel risus ligula. Aliquam tempus maximus dui id malesuada. In pellentesque rutrum tellus, accumsan euismod augue pulvinar quis. Proin sed egestas lorem.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-12 infs" id="infs">
            <div class="row">
                <div class="col-lg-4 card border-0 inf">
                    <img src="images/portrait15.jpg" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title"><u><b>#4WITNESS</b></u></h5>
                        <p class="card-text">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a vulputate arcu, lobortis elementum ipsum. Curabitur vestibulum turpis eu semper porttitor. Duis at turpis vitae augue condimentum hendrerit. Phasellus a arcu et magna pulvinar sagittis. Aenean volutpat nunc vel vulputate tincidunt. Ut interdum neque non ante mollis vulputate. Aliquam erat volutpat. Fusce vulputate, massa sit amet aliquam accumsan, neque nulla dictum odio, sed mollis diam felis sed orci. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vivamus vel risus ligula. Aliquam tempus maximus dui id malesuada. In pellentesque rutrum tellus, accumsan euismod augue pulvinar quis. Proin sed egestas lorem.</p>
                    </div>
                </div>
                <div class="col-lg-4 card border-0  inf">
                    <img src="images/portrait16.jpg" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title"><u><b>#5WITNESS</b></u></h5>
                        <p class="card-text">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a vulputate arcu, lobortis elementum ipsum. Curabitur vestibulum turpis eu semper porttitor. Duis at turpis vitae augue condimentum hendrerit. Phasellus a arcu et magna pulvinar sagittis. Aenean volutpat nunc vel vulputate tincidunt. Ut interdum neque non ante mollis vulputate. Aliquam erat volutpat. Fusce vulputate, massa sit amet aliquam accumsan, neque nulla dictum odio, sed mollis diam felis sed orci. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vivamus vel risus ligula. Aliquam tempus maximus dui id malesuada. In pellentesque rutrum tellus, accumsan euismod augue pulvinar quis. Proin sed egestas lorem.</p>
                    </div>
                </div>
                <div class="col-lg-4 card border-0  inf">
                    <img src="images/portrait17.jpg" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title"><u><b>#6WITNESS</b></u></h5>
                        <p class="card-text">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a vulputate arcu, lobortis elementum ipsum. Curabitur vestibulum turpis eu semper porttitor. Duis at turpis vitae augue condimentum hendrerit. Phasellus a arcu et magna pulvinar sagittis. Aenean volutpat nunc vel vulputate tincidunt. Ut interdum neque non ante mollis vulputate. Aliquam erat volutpat. Fusce vulputate, massa sit amet aliquam accumsan, neque nulla dictum odio, sed mollis diam felis sed orci. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vivamus vel risus ligula. Aliquam tempus maximus dui id malesuada. In pellentesque rutrum tellus, accumsan euismod augue pulvinar quis. Proin sed egestas lorem.</p>
                    </div>
                </div>
            </div>
